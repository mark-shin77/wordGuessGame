...
// =======================================================================
// Word List
var selectableWords = ['SUPREME', 'PALACE', 'BAPE', 'OFF WHITE', 'JORDAN', 
                       'UNDERCOVER', 'LOUIS VUITTON', 'ANTISOCIAL SOCIAL CLUB',
                       'CHAMPION', 'RICK OWENS', 'YEEZY', 'COMME DES GARCONS', 
                       'SAINT LAURENT PARIS', 'ACNE STUDIOS'];
...
function resetGame() {
    ...
    var currentWord = selectableWords[currentWordIndex];
